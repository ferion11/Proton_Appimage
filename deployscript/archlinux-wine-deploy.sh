...
export ARCH=x86_64; squashfs-root/AppRun -v $WINE_WORKDIR -u 'gh-releases-zsync|ferion11|Proton_Appimage|continuous|${P_NAME}-v${P_VERSION}-${P_CSOURCE}-*arch*.AppImage.zsync' ${P_NAME}-v${P_VERSION}-${P_CSOURCE}-${ARCH}.AppImage
